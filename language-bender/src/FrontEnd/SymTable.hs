...
initDic = M.fromList [("air", [Symbol "air" (Type AST.TInt 4 4) 0 Nothing])
                    ...
                    , ("readair",    [Symbol "readair"    (Procedure [AST.FuncArg "var_to_read" (AST.TReference AST.TInt) Nothing (-7)] (AST.ConstNull AST.TVoid) 80) 0 Nothing])
                    , ("readwater",  [Symbol "readwater"  (Procedure [AST.FuncArg "var_to_read" (AST.TReference AST.TFloat) Nothing (-8)] (AST.ConstNull AST.TVoid) 80) 0 Nothing])
                    , ("readfire",   [Symbol "readfire"   (Procedure [AST.FuncArg "var_to_read" (AST.TReference AST.TBool) Nothing (-9)] (AST.ConstNull AST.TVoid) 80) 0 Nothing])
                    , ("readearth",  [Symbol "readearth"  (Procedure [AST.FuncArg "var_to_read" (AST.TReference AST.TChar) Nothing (-10)] (AST.ConstNull AST.TVoid) 80) 0 Nothing])
                    , ("readmetal",  [Symbol "readmetal"  (Procedure [AST.FuncArg "var_to_read" (AST.TReference (AST.TArray AST.TChar (AST.ConstInt 0 AST.TInt))) Nothing (-11)] (AST.ConstNull AST.TVoid) 80) 0 Nothing])
                    ...
                    , ("printmetal", [Symbol "printmetal" (Procedure [AST.FuncArg "src" (AST.TArray AST.TChar (AST.ConstInt 0 AST.TInt)) Nothing (-6)] (AST.ConstNull AST.TVoid) 80) 0 Nothing])
                    ]
...
getTypeSize st AST.TArray{AST.arrType = t, AST.size = s} = 
    case s of
        AST.ConstInt val _ -> 8--val * (getTypeSize st t) -- dope vector
        _                  -> 8 -- dope vector
